      ...
      <div className='relative h-96 overflow-hidden'>
        ...
        <div className='absolute inset-0 flex items-end'>
          <div className='p-8 md:p-12 w-full'>
            <Link
              href='/'
              className='text-gray-300 hover:text-red-400 mb-4 inline-block'
            >
              ← Back Home
            </Link>
      ...
      <div className='max-w-6xl mx-auto px-6 md:px-8 py-12'>
        ...
        <div className='mb-12'>
          ...
          <div className='grid md:grid-cols-2 gap-4'>
            {itinerary.highlights.map((highlight, idx) => (
              <div
                key={idx}
                className='flex items-start gap-3 bg-[#2a1115] border border-[#8b3a3d] p-4 rounded-lg'
              >
        ...
        <div className='mb-12'>
          ...
          <div className='space-y-6'>
            {itinerary.dayPlans.map((day, idx) => (
              <div
                key={idx}
                className='bg-[#2a1115] border border-[#8b3a3d] rounded-lg overflow-hidden hover:border-red-400 transition-colors'
              >
                {/* Day Header */}
        ...
        <div className='mb-12'>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-3'>
            {itinerary.packing.map((item, idx) => (
              <div
                key={idx}
                className='flex items-start gap-2 bg-[#2a1115] p-4 rounded border border-[#8b3a3d]'
              >
                <span className='text-red-400 font-bold'>📦</span>
        ...
        <div className='bg-gradient-to-r from-[#d4344f] to-[#8b3a3d] rounded-lg p-8 md:p-12 text-center mb-12'>
          ...
          <p className='text-lg mb-8 text-white/90'>
            Contact our travel specialists to customize this itinerary for your
