...
export default function NavDropdown({
  ...
  return (
    <>
      {/* Backdrop */}
      <div
        className='fixed inset-0 bg-black/90 transition-opacity duration-300 z-40'
        onClick={onClose}
      />

      {/* Dropdown Card - Full Height */}
      <div className='fixed top-0 md:top-20 left-0 right-0 bottom-0 z-50 animate-in fade-in slide-in-from-top-2 duration-300'>
        <div className='h-full bg-[#180109] overflow-y-auto'>
