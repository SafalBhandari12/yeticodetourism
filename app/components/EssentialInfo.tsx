...
const BackgroundPattern = ({
  ...
  switch (type) {
    case "currency":
      return (
        <svg
          className={`absolute -right-4 -bottom-4 w-48 h-48 opacity-5 ${colorClass} pointer-events-none`}
          viewBox='0 0 200 200'
          fill='none'
        ...
        >
          ...
          />
          <path
            d='M100 40V160M60 80H140M60 120H140'
            stroke='currentColor'
            strokeWidth='4'
            strokeLinecap='round'
          />
    ...
    case "sim":
      return (
        ...
        >
          <path
            d='M40 160C40 160 60 100 100 100C140 100 160 160 160 160'
            stroke='currentColor'
            strokeWidth='4'
            strokeLinecap='round'
          />
          <path
            d='M20 140C20 140 50 60 100 60C150 60 180 140 180 140'
            stroke='currentColor'
            strokeWidth='4'
            strokeLinecap='round'
          />
    ...
    case "phrases":
      return (
        ...
        >
          <path
            d='M40 140V60C40 48.9543 48.9543 40 60 40H140C151.046 40 160 48.9543 160 60V120C160 131.046 151.046 140 140 140H80L40 180V140Z'
            stroke='currentColor'
            strokeWidth='4'
          />
    ...
    case "safety":
      return (
        ...
        >
          <path
            d='M100 20L40 50V110C40 145 65 175 100 190C135 175 160 145 160 110V50L100 20Z'
            stroke='currentColor'
            strokeWidth='4'
          />
          <path
            d='M80 100L120 100M100 80L100 120'
            stroke='currentColor'
            strokeWidth='4'
            strokeLinecap='round'
          />
        ...
        <div className='space-y-6'>
          ...
          {data.highlight && (
            ...
            >
              <div>
                <p
                  className={`text-xs font-bold uppercase tracking-widest ${colors.text} mb-1`}
                >
                  Exchange Rate
                </p>
      ...
      return (
        <div className='space-y-5'>
          ...
          <div className='flex gap-3'>
            <div
              className={`flex-1 bg-${colors.text.replace(
                "text-",
                ""
              )}-500/20 border border-${colors.text.replace(
                "text-",
                ""
      ...
      return (
        <div className='grid grid-cols-2 gap-4 h-full content-center'>
          {[
            ...
            <div
              key={i}
              className='bg-white/5 p-3 rounded-xl border border-white/5 hover:border-white/20 transition-all group/item'
            >
        ...
        <div className='space-y-4'>
          ...
          <div className='grid grid-cols-3 gap-2'>
            {[
              ...
              <div
                key={i}
                className='bg-white/5 rounded-lg p-2 text-center border border-white/5 hover:border-white/20 transition-colors'
              >
                <span className='block text-xs text-gray-400 mb-1'>
                  {plan.days} Days
                </span>
                <span className={`block text-lg font-bold ${colors.text}`}>
                  {plan.price}
                </span>
              </div>
            ))}
      ...
      return (
        <div className='space-y-3'>
          ...
          <div className='flex gap-2 mt-2'>
            <div className='flex-1 bg-white/5 p-2 rounded text-center text-xs text-gray-300'>
              Jam Jam (Let's go)
            </div>
            <div className='flex-1 bg-white/5 p-2 rounded text-center text-xs text-gray-300'>
              Dai/Didi (Bro/Sis)
        ...
        <div className='space-y-5'>
          <div className='flex gap-3'>
            <div className='flex-1 bg-red-500/20 border border-red-500/30 p-3 rounded-xl flex items-center gap-3'>
              ...
              <div>
                <p className='text-[10px] text-red-300 uppercase font-bold'>
                  Police
                </p>
      ...
      >
        {variant === "mobile" ? (
          ...
          <>
            {/* Hover Glow Effect */}
            <div
              className={`absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500 bg-${colorName}-500`}
            />
            ...
            <div className='relative z-10 flex flex-col items-center justify-center h-full px-4 py-6 gap-4'>
              ...
              <div className='relative'>
                <div
                  className={`absolute inset-0 bg-${colorName}-500 blur-2xl opacity-0 group-hover:opacity-30 transition-opacity duration-500 rounded-full`}
                />
                <div
                  className={`text-4xl ${data.color} p-3 bg-white/5 rounded-2xl border border-white/10 group-hover:scale-110 group-hover:-rotate-3 transition-all duration-500`}
                >
                  {data.icon}
                </div>
              </div>
              ...
              {/* Action Indicator */}
              <div
                className={`flex items-center gap-2 text-xs font-bold uppercase tracking-wider ${data.color} opacity-60 group-hover:opacity-100 group-hover:translate-y-1 transition-all duration-300`}
              >
          ...
          <>
            {/* Top Accent Line */}
            <div
              className={`absolute top-0 left-0 w-full h-1.5 ${colors.bg}`}
            />
            ...
            <div className='relative z-10 flex flex-col h-full p-8'>
              ...
              <div className='flex items-center gap-5 mb-6'>
                <div
                  className={`w-14 h-14 p-3 rounded-xl ${colors.bg} text-black shadow-lg transform group-hover:scale-105 transition-transform duration-300 flex items-center justify-center`}
                >
                  {data.icon}
                </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`bg-linear-to-r ${colors.gradient
            .replace("from-", "from-")
            .replace(
              "500",
              "900"
            )}/20 to-transparent p-8 md:p-10 border-b border-white/5`}
        >
        ...
        <div className='p-8 md:p-10 relative z-10'>
          ...
          {data.highlight && (
            <div
              className={`bg-white/5 border-l-4 ${colors.border} p-6 mb-10 rounded-r-xl`}
            >
              <p
              ...
              <li key={idx} className='flex gap-5 items-start group/item'>
                <span
                  className={`${colors.text.replace(
                    "400",
                    "500"
                  )} font-bold mt-1 shrink-0 text-xl`}
                >
                  ●
                </span>
                <div className='flex-1'>
