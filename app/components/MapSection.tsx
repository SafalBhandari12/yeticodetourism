...
export default function MapSection() {
  ...
  const visibleMarkers = MARKERS.filter(
    (marker) => activeCategory === "all" || marker.type === activeCategory
  );
            ...
            <div className='relative w-full aspect-[800/454]'>
              ...
              >
                ...
                <path
                  ...
                  id='NP-BA'
                  className={`cursor-pointer transition-all duration-300 hover:fill-[#d4344f] hover:opacity-100 ${
                    activeRegion === "NP-BA"
                      ? "fill-[#d4344f] opacity-100 stroke-white stroke-2"
                      : "fill-gray-800 opacity-80 stroke-gray-700 hover:stroke-white"
                  }`}
