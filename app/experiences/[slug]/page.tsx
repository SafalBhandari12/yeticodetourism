...
import { getExperienceContent } from "@/lib/contentData";
...
export default function ExperienceDetail() {
  ...
  const data = getExperienceContent(slug);
    ...
    <div className='min-h-screen bg-[#0f0a0e] text-white pt-24 pb-16'>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8'>
        <nav className='flex items-center gap-2 text-sm'>
          ...
          <Link href='/experiences' className='text-gray-400 hover:text-[#d4344f] transition-colors'>
            Experiences
          </Link>
          <span className='text-gray-600'>/</span>
